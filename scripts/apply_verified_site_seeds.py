...
def main() -> None:
    ...
    parser.add_argument(
        "--seeds",
        required=True,
        help="JSON array containing organisation_number, website and proof_url",
    )
    ...
    for profile in profiles:
        ...
        if not website.startswith(("https://", "http://")) or not proof_url.startswith(
            ("https://", "http://")
        ):
        ...
        applied.append(
            {"organisation_number": org, "website": website, "proof_url": proof_url}
        )
