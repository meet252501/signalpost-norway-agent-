...
def observation(profile: dict) -> dict | None:
    ...
    return {
        ...
        "metrics": {
            ...
            "structured_organisation_records": len(
                value.get("structured_organisations") or []
            ),
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Extract reproducible activity metrics from exact company-site snapshots."
    )
